%This file is used to create a 0.075 amplitude ideal secret message using
%the agent simulation, secret come from using gama=0, sigma=0 and P=1, (and SpeedUnit 0.1) from
...
%80, the secret is sent in frame 500
...
%S2 = 0.5*square(t/2);
S2 = ((secret)/15000)-0.333;  %alternating positive and negative values is important! the y axis displacement varies depending on 
