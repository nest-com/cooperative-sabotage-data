...
plot(DataCH8(1,:), DataCH8(2,:),'-','Color','#0072BD','LineWidth', 2,'MarkerSize', 8);
% hold
...
ylim([-0.1 1.1])
xlim([-0.002 0.02])
legend('Amplitude = 0.05%','Location','southeast','FontSize',12);

set(gca, 'FontSize', 12, 'FontWeight', 'bold');
box off;
plot_fig.Position = [680 458 645 316];
exportgraphics(gca, 'ConvexCombinedROC1amplitudes.png', 'Resolution', 300);
