...
plot(DataCH2(1,:), DataCH2(2,:),'-','Color','#0072BD','LineWidth', 2,'MarkerSize', 8);
hold
plot(DataCH1(1,:), DataCH1(2,:),'-.','Color','#D95319','LineWidth', 4.5,'MarkerSize', 8);
...
title('ROC Curves for amplitudes for secret lenght 480 s', 'FontSize', 14, 'FontWeight', 'bold', 'Interpreter', 'tex');
grid on;
xlabel('FPR', 'FontSize', 12, 'Interpreter', 'latex');
ylabel('TPR', 'FontSize', 12, 'Interpreter', 'latex');
ylim([-0.1 1.1])
xlim([-0.002 0.02])
legend('0.2% Amplitude','0.1% Amplitude','Location','southeast','FontSize',12);

set(gca, 'FontSize', 12, 'FontWeight', 'bold');
box off;
plot_fig.Position = [680 458 645 316];
exportgraphics(gca, 'ROC2amplitudes_480s.png', 'Resolution', 300);
