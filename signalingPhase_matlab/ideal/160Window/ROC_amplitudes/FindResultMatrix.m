...
%uncomment and add ceiling of max as the last point for Trial1b
L1b= length(Trial1b)
...
%uncomment and add ceiling of max as the last point for Trial2b
L2b= length(Trial2b)
...
%uncomment and add ceiling of max as the last point for Trial7b
L7b= length(Trial7b)
for i=1:7
    for j=1:821
        for k7=1:L7b
