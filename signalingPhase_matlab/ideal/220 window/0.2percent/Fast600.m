%This file is used to create a 0.2 amplitude ideal secret message using
...
%80, the secret is sent in frame 600
...
%S2 = 0.5*square(t/2);
S2 = ((secret)/5000)-1;  %alternating positive and negative values is important! the y axis displacement varies depending on 
