...
message_start_time = 750      # Expected start time (seconds) 750
message_duration = 150         # Expected duration (seconds) 150
amplitude_percent = 0.001      # Expected amplitude (0.1%)

# Advanced parameters
window_size = 100              # FastICA window size 
...
print('=' * 40)
print('FastICA Hidden Message Detection')
print('=' * 40)
print()
