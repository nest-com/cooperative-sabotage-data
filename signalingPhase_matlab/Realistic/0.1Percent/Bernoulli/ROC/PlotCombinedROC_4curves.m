...
plot((DataCH1(1,:)-0.0)/0.22, DataCH1(2,:),'-','Color','#0072BD','LineWidth', 2,'MarkerSize', 8);
hold
...
title('ROC Curves for different P values', 'FontSize', 14, 'FontWeight', 'bold', 'Interpreter', 'tex');
grid on;
...
exportgraphics(gca, 'ConvexCombinedROC3P.png', 'Resolution', 300);
